...
(() => {
  ...
  // D:/mp/anydoor-v2/src/unpackage/dist/dev/.nvue/pages/index/index.js
  ...
  var isDate = (val2) => toTypeString(val2) === "[object Date]";
  var isRegExp = (val2) => toTypeString(val2) === "[object RegExp]";
  ...
  var isPlainObject = (val2) => toTypeString(val2) === "[object Object]";
  var toDisplayString = (val2) => {
...
${codeFrame}` : message);
  ...
  function defineCoreMissingHandler(missing) {
    return (ctx, locale, key, type) => {
      return missing(locale, key, (0, import_vue.getCurrentInstance)() || void 0, type);
    };
  }
  ...
  function createComposer(options = {}) {
    ...
    const _locale = (0, import_vue.ref)(__root && _inheritLocale ? __root.locale.value : isString(options.locale) ? options.locale : "en-US");
    const _fallbackLocale = (0, import_vue.ref)(__root && _inheritLocale ? __root.fallbackLocale.value : isString(options.fallbackLocale) || isArray(options.fallbackLocale) || isPlainObject(options.fallbackLocale) || options.fallbackLocale === false ? options.fallbackLocale : _locale.value);
    const _messages = (0, import_vue.ref)(getLocaleMessages(_locale.value, options));
    const _datetimeFormats = (0, import_vue.ref)(isPlainObject(options.datetimeFormats) ? options.datetimeFormats : { [_locale.value]: {} });
    const _numberFormats = (0, import_vue.ref)(isPlainObject(options.numberFormats) ? options.numberFormats : { [_locale.value]: {} });
    ...
    const fallbackLocale = (0, import_vue.computed)({
    ...
    const messages = (0, import_vue.computed)(() => _messages.value);
    const datetimeFormats = (0, import_vue.computed)(() => _datetimeFormats.value);
    const numberFormats = (0, import_vue.computed)(() => _numberFormats.value);
    ...
    function normalize(values) {
      return values.map((val2) => isString(val2) ? (0, import_vue.createVNode)(import_vue.Text, null, val2, 0) : val2);
    }
    ...
    function transrateVNode(...args) {
      return wrapWithDeps((context) => {
        ...
        return ret;
      }, () => parseTranslateArgs(...args), "translate", (root) => root[TransrateVNodeSymbol](...args), (key) => [(0, import_vue.createVNode)(import_vue.Text, null, key, 0)], (val2) => isArray(val2));
    }
    ...
    composerID++;
    if (__root) {
      (0, import_vue.watch)(__root.locale, (val2) => {
        if (_inheritLocale) {
          _locale.value = val2;
      ...
      (0, import_vue.watch)(__root.fallbackLocale, (val2) => {
        if (_inheritLocale) {
          _fallbackLocale.value = val2;
  ...
  ({
    ...
    setup(props, context) {
      ...
      return () => {
        ...
        return isString(props.tag) ? (0, import_vue.h)(props.tag, assignedAttrs, children) : isObject$2(props.tag) ? (0, import_vue.h)(props.tag, assignedAttrs, children) : (0, import_vue.h)(import_vue.Fragment, assignedAttrs, children);
      };
    }
  });
  ...
  function useI18n(options = {}) {
    ...
    const i18n = (0, import_vue.inject)(instance.appContext.app.__VUE_I18N_SYMBOL__);
    if (!i18n) {
  ...
  var _sfc_main$i = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { expose }) {
      ...
      let view_height = (0, import_vue.ref)(windowHeight + (windowTop || 0));
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          ...
          isSetThemeOk.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
            key: 0,
            class: (0, import_vue.normalizeClass)(["flex flex-col flex-1", [__props.blur ? "blur" : ""]]),
      ...
      return (_ctx, _cache) => {
        return _blue_sheet.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          ...
          style: (0, import_vue.normalizeStyle)([
            ...
            !(0, import_vue.unref)(_transprent) && (0, import_vue.unref)(_blur) ? { "backdrop-filter": "blur(10px)" } : "",
            (0, import_vue.unref)(customCSSStyle)
          ])
        }, [
          (0, import_vue.createElementVNode)("view", {
            renderWhole: true,
            class: (0, import_vue.normalizeClass)(["flex  flex-col flex-1", (0, import_vue.unref)(customClass)]),
  ...
  var _sfc_main$g = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "tm-text",
    props: __spreadProps(__spreadValues({}, custom_props), {
      label: {
        type: [String, Number],
  ...
  var _sfc_main$f = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      (0, import_vue.computed)(() => parseInt(props.fontSize || 34) + custom_space_size[0]);
      (0, import_vue.computed)(() => parseInt(props.fontSize || 34) + custom_space_size[1]);
  ...
  var _sfc_main$e = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const props = __props;
      const { proxy } = (0, import_vue.getCurrentInstance)();
      const formtype = (0, import_vue.computed)(() => props.formType);
      let FormParent = null;
      ...
      const customCSSStyle = (0, import_vue.computed)(() => computedStyle(props));
      const customClass = (0, import_vue.computed)(() => computedClass(props));
      const isclickOn = (0, import_vue.ref)(false);
      const _load = (0, import_vue.computed)(() => props.loading);
      const _disabled = (0, import_vue.computed)(() => props.disabled);
      const _label = (0, import_vue.computed)(() => props.label);
      const _icon = (0, import_vue.computed)(() => props.icon);
      const sizeObj = {
      ...
      const btnSizeObj = (0, import_vue.computed)(() => {
      ...
      const _fontColor = (0, import_vue.computed)(() => props.fontColor);
      function touchstart(e) {
      ...
      return (_ctx, _cache) => {
        ...
        return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmSheet, {
          "no-level": "",
          _style: [{ opacity: isclickOn.value || (0, import_vue.unref)(_disabled) ? 0.7 : 1 }],
          "hover-class": "bhover",
          round: (0, import_vue.unref)(btnSizeObj).round,
          width: (0, import_vue.unref)(btnSizeObj).w,
          height: (0, import_vue.unref)(btnSizeObj).h,
          ...
          default: (0, import_vue.withCtx)(() => [
            (0, import_vue.createVNode)(_component_button, {
              ...
              loading: (0, import_vue.unref)(_load),
              disabled: (0, import_vue.unref)(_disabled),
              "hover-start-time": 1e7,
              "hover-stop-propagation": "",
              "hover-class": "buttonHover",
              class: (0, import_vue.normalizeClass)(["button flex-1 flex-center", [(0, import_vue.unref)(customClass)]]),
              style: (0, import_vue.normalizeStyle)([[{ height: (0, import_vue.unref)(btnSizeObj).h + "rpx" }, (0, import_vue.unref)(customCSSStyle)], { "border": "0px solid rgba(0, 0, 0, 0)", "background": "rgba(0, 0, 0, 0)", "border-radius": "0px" }])
            }, {
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue.unref)(_icon) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                    key: 0,
                    userInteractionEnabled: false,
                    color: (0, import_vue.unref)(_fontColor),
                    _class: (0, import_vue.unref)(_label) ? "pr-10" : "",
                    fontSize: (0, import_vue.unref)(btnSizeObj).fontSize * 0.9,
                    name: (0, import_vue.unref)(_icon)
                  }, null, 8, ["color", "_class", "fontSize", "name"])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.createVNode)(tmText, {
                    userInteractionEnabled: false,
                    color: (0, import_vue.unref)(_fontColor),
                    fontSize: (0, import_vue.unref)(btnSizeObj).fontSize,
                    label: (0, import_vue.unref)(_label)
  ...
  var _sfc_main$d = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const isH5 = (0, import_vue.ref)(false);
      const showActions = (0, import_vue.ref)((_a2 = props.showActions) != null ? _a2 : false);
      const BtnPos = (0, import_vue.computed)(() => props.position);
      const AcionPos = (0, import_vue.computed)(() => props.actionsPos);
      const _offset = (0, import_vue.computed)(() => {
        var _a3;
        let ost = (_a3 = props.offset) != null ? _a3 : [0, 0];
        ost = [uni.upx2px(props.offset[0]), uni.upx2px(props.offset[1])];
        return ost;
      });
      const centerPosLeft = (0, import_vue.computed)(() => {
        let ps = (windowWidth - uni.upx2px(props.width * 1.5)) / 2 + uni.upx2px(_offset.value[0]);
        return ps;
      });
      const _btn = (0, import_vue.computed)(() => {
        var _a3;
      ...
      const _actionsItem = (0, import_vue.computed)(() => {
      ...
      const AcionPos_xy = (0, import_vue.computed)(() => {
      ...
      const parent_style = (0, import_vue.computed)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          ...
          style: (0, import_vue.normalizeStyle)([
            (0, import_vue.unref)(BtnPos) == "tl" ? { transform: `translateX(${(0, import_vue.unref)(_offset)[0]}rpx) translateY(${(0, import_vue.unref)(_offset)[1]}rpx)` } : "",
            (0, import_vue.unref)(BtnPos) == "tr" ? { transform: `translateX(-${(0, import_vue.unref)(_offset)[0]}rpx) translateY(${(0, import_vue.unref)(_offset)[1]}rpx)`, right: "0px" } : "",
            (0, import_vue.unref)(BtnPos) == "tc" ? { transform: `translateX(${(0, import_vue.unref)(centerPosLeft)}px) translateY(${(0, import_vue.unref)(_offset)[1]}rpx)` } : "",
            (0, import_vue.unref)(BtnPos) == "bl" ? { transform: `translateX(${(0, import_vue.unref)(_offset)[0]}rpx) translateY(-${(0, import_vue.unref)(_offset)[1]}rpx)`, bottom: "0px" } : "",
            (0, import_vue.unref)(BtnPos) == "br" ? { transform: `translateX(-${(0, import_vue.unref)(_offset)[0]}rpx) translateY(-${(0, import_vue.unref)(_offset)[1]}rpx)`, right: "0px", bottom: "0px" } : "",
            (0, import_vue.unref)(BtnPos) == "bc" ? { transform: `translateX(${(0, import_vue.unref)(centerPosLeft)}px) translateY(-${(0, import_vue.unref)(_offset)[1]}rpx)`, bottom: "0px" } : "",
            !isH5.value && ((0, import_vue.unref)(BtnPos) == "tl" || (0, import_vue.unref)(BtnPos) == "tc" || (0, import_vue.unref)(BtnPos) == "tr") ? { top: "0px" } : "",
            (0, import_vue.unref)(parent_style)
          ])
        }, [
          (0, import_vue.createCommentVNode)(" \u4E3B\u6309\u94AE "),
          (0, import_vue.createElementVNode)("view", {
            style: (0, import_vue.normalizeStyle)([{ width: props.width + "rpx", height: props.height + "rpx" }]),
            class: "flex-center"
          }, [
            (0, import_vue.createVNode)(tmSheet, {
              transprent: true,
              padding: [0, 0],
              margin: [0, 0],
              color: (0, import_vue.unref)(_btn).color
            }, {
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.renderSlot)(_ctx.$slots, "default", {}, () => [
                  (0, import_vue.createVNode)(tmButton, {
                    followTheme: props.followTheme,
                    onClick: onclick,
                    _class: "flex flex-col flex-col-center-center",
                    shadow: 3,
                    linear: (0, import_vue.unref)(_btn).linear,
                    "linear-deep": (0, import_vue.unref)(_btn).linearDeep,
                    color: (0, import_vue.unref)(_btn).color,
                    margin: [0, 0],
                    round: 16,
                    padding: [0, 0],
                    ...
                    default: (0, import_vue.withCtx)(() => [
                      (0, import_vue.createVNode)(tmIcon, {
                        userInteractionEnabled: false,
                        "follow-dark": false,
                        color: (0, import_vue.unref)(_btn).fontColor,
                        name: (0, import_vue.unref)(_btn).icon,
                        "font-size": (0, import_vue.unref)(_btn).iconSize
                      }, null, 8, ["color", "name", "font-size"]),
                      (0, import_vue.unref)(_btn).label ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                        key: 0,
                        userInteractionEnabled: false,
                        "follow-dark": false,
                        color: (0, import_vue.unref)(_btn).fontColor,
                        label: (0, import_vue.unref)(_btn).label,
                        "font-size": (0, import_vue.unref)(_btn).fontSize
                      }, null, 8, ["color", "label", "font-size"])) : (0, import_vue.createCommentVNode)("v-if", true)
                    ]),
                    _: 1
          ...
          (0, import_vue.createCommentVNode)(" \u5B50\u83DC\u5355 "),
          (0, import_vue.unref)(_actionsItem).length > 0 && showActions.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
            key: 0,
            userInteractionEnabled: showActions.value,
            class: "absolute flex",
            style: (0, import_vue.normalizeStyle)([(0, import_vue.unref)(AcionPos_xy)])
          }, [
            (0, import_vue.createElementVNode)("view", {
              style: (0, import_vue.normalizeStyle)([{ width: props.width + "rpx", height: props.height + "rpx" }]),
              class: "flex-center"
            }, [
              ((0, import_vue.openBlock)(true), (0, import_vue.createElementBlock)(import_vue.Fragment, null, (0, import_vue.renderList)((0, import_vue.unref)(_actionsItem), (item, index2) => {
                return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmSheet, {
                  followTheme: props.followTheme,
                  ...
                  default: (0, import_vue.withCtx)(() => [
                    ...
                    item.label ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                      key: 0,
                      userInteractionEnabled: false,
                      color: item.fontColor,
                      label: item.label,
          ...
          ], 12, ["userInteractionEnabled"])) : (0, import_vue.createCommentVNode)("v-if", true)
        ], 4);
      };
    }
  });
  ...
  var _sfc_main$b = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const timeid = (0, import_vue.ref)(uni.$tm.u.getUid(3));
      const animationData = (0, import_vue.ref)(null);
      const showMask = (0, import_vue.ref)(false);
      (0, import_vue.onUnmounted)(() => clearTimeout(timeid.value));
      const align_rpx = (0, import_vue.computed)(() => props.align);
      const bgColor_rp = (0, import_vue.computed)(() => {
      ...
      (0, import_vue.watch)(() => props.show, (newval) => {
        open(newval);
      });
      expose({ close, open });
      return (_ctx, _cache) => {
        return showMask.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          key: 0,
          ref: "overlay",
          onClick: (0, import_vue.withModifiers)(close, ["stop"]),
          class: (0, import_vue.normalizeClass)([(0, import_vue.unref)(bgColor_rp) && !props.transprent ? "blurbg" : "", (0, import_vue.unref)(align_rpx), " navbarheight flex flex-col  l-0  ", (0, import_vue.unref)(customClass)]),
          style: (0, import_vue.normalizeStyle)([
            (0, import_vue.unref)(bgColor_rp) && !props.transprent ? { backgroundColor: showMask.value ? (0, import_vue.unref)(bgColor_rp) : "" } : "",
            { position: "fixed" },
          ...
          (0, import_vue.renderSlot)(_ctx.$slots, "default")
        ], 14, ["onClick", "animation"])) : (0, import_vue.createCommentVNode)("v-if", true);
      };
    }
  });
  ...
  var _sfc_main$a = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "tm-message",
    props: {
      _style: {
        type: [Array, String, Object],
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const store = useTmpiniaStore();
      const { proxy } = (0, import_vue.getCurrentInstance)();
      const uid = (0, import_vue.ref)(uni.$tm.u.getUid(5));
      const bgColor = (0, import_vue.ref)("white");
      const model_ref = (0, import_vue.ref)(modelType.info);
      const showValue = (0, import_vue.ref)(false);
      const icon_ref = (0, import_vue.ref)("");
      const text_ref = (0, import_vue.ref)("");
      const color_ref = (0, import_vue.ref)("");
      const reverse = (0, import_vue.ref)(false);
      const dur = (0, import_vue.ref)(0);
      (0, import_vue.ref)(false);
      const showMask = (0, import_vue.ref)(props.mask);
      const dark_ref = (0, import_vue.ref)(false);
      (0, import_vue.onUnmounted)(() => clearTimeout(uid.value));
      (0, import_vue.watch)(() => props.mask, (val2) => showMask.value = val2);
      const zindex = "";
      const modelIcon = (0, import_vue.computed)(() => {
        return {
          load: {
            icon: "tmicon-loading",
            color: "primary",
      ...
      expose({ show, hide });
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmOverlay, {
          ...
          default: (0, import_vue.withCtx)(() => [
            (0, import_vue.createVNode)(tmTranslate, {
              onEnd: msgOver,
  ...
  var _sfc_main$9 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "tm-input",
    props: __spreadProps(__spreadValues({}, custom_props), {
      followTheme: {
        type: [Boolean, String],
    ...
    setup(__props, { emit: emits }) {
      ...
      const tmcfg = (0, import_vue.computed)(() => store.tmStore);
      (0, import_vue.computed)(() => computedStyle(props));
      (0, import_vue.computed)(() => computedClass(props));
      const isDark = (0, import_vue.computed)(() => computedDark(props, tmcfg.value));
      const _requiredError = (0, import_vue.ref)(false);
      const _foucsActive = (0, import_vue.ref)(props.focus || false);
      (0, import_vue.watch)(() => props.focus, () => {
        _foucsActive.value = props.focus;
      });
      const _color = (0, import_vue.computed)(() => {
      ...
      const showPasswordText = (0, import_vue.ref)(propsDetail.value.password);
      const showPasswordIcon = (0, import_vue.computed)(() => props.password);
      (0, import_vue.ref)(props.errorLabel);
      const _value = (0, import_vue.ref)(props.modelValue);
      const _valueLenChar = (0, import_vue.computed)(() => {
        let str = String(_value.value).split("");
        return str.length;
      });
      (0, import_vue.watch)(() => props.modelValue, () => _value.value = props.modelValue);
      const rulesObj = (0, import_vue.inject)("tmFormItemRules", (0, import_vue.computed)(() => {
        var _a3;
        return [{
      ...
      (0, import_vue.watch)(_value, () => uni.$tm.u.debounce(() => pushFormItem(), 350));
      const tmFormFun = (0, import_vue.inject)("tmFormFun", (0, import_vue.computed)(() => ""));
      ...
      function pushFormItem(isCheckVail = true) {
        return __async(this, null, function* () {
          if (parentFormItem) {
            if (isCheckVail) {
              validate((0, import_vue.toRaw)(rulesObj.value)).then((ev) => {
        ...
        return (0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmSheet, {
          ...
          default: (0, import_vue.withCtx)(() => [
            (0, import_vue.createVNode)(tmSheet, {
              ...
              "no-level": "",
              margin: [0, 0],
              padding: (0, import_vue.unref)(_inputPadding),
              border: props.border,
              text: props.text,
              color: (0, import_vue.unref)(_color),
              outlined: props.outlined,
              shadow: props.shadow,
              linear: props.linear,
              ...
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.createElementVNode)("view", {
                  class: (0, import_vue.normalizeClass)(["flex flex-row", [(0, import_vue.unref)(propsDetail).type == "textarea" ? "flex-row-top-center" : "flex-row-center-center"]]),
                  style: (0, import_vue.normalizeStyle)([{ height: `${(0, import_vue.unref)(_height)}rpx` }])
                }, [
                  (0, import_vue.unref)(propsDetail).search || (0, import_vue.unref)(propsDetail).searchLabel ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 0,
                    class: "px-9"
                  })) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.renderSlot)(_ctx.$slots, "left"),
                  (0, import_vue.unref)(propsDetail).prefix ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 1,
                    class: "pr-16"
                  }, [
                    (0, import_vue.createVNode)(tmIcon, {
                      "font-size": (0, import_vue.unref)(propsDetail).fontSize,
                      name: (0, import_vue.unref)(propsDetail).prefix
                    }, null, 8, ["font-size", "name"])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.unref)(propsDetail).prefixLabel ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 2,
                    class: "pr-24"
                  }, [
                    (0, import_vue.createVNode)(tmText, {
                      "font-size": (0, import_vue.unref)(propsDetail).fontSize,
                      label: (0, import_vue.unref)(propsDetail).prefixLabel
                    }, null, 8, ["font-size", "label"])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  !isAndroid.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 3,
                    onClick: _cache[2] || (_cache[2] = ($event) => emits("click", $event)),
                    class: "flex-1 relative flex-row flex",
                    style: (0, import_vue.normalizeStyle)([{ width: "0px" }])
                  }, [
                    (0, import_vue.createCommentVNode)(` <view @click.stop="emits('click',$event)" class=" l-0 t-0 flex-1 " :style="{height: \`\${_height}rpx\`,background:'red'}"></view> `),
                    (0, import_vue.unref)(propsDetail).type != "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-input", {
                      key: 0,
                      class: "flex-1",
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue.unref)(propsDetail).focus,
                      onFocus: focus,
                      onBlur: blur,
                      onConfirm: confirm,
                      ...
                      maxlength: (0, import_vue.unref)(propsDetail).maxlength,
                      disabled: (0, import_vue.unref)(propsDetail).disabled,
                      cursorSpacing: (0, import_vue.unref)(propsDetail).cursorSpacing,
                      confirmType: (0, import_vue.unref)(propsDetail).confirmType,
                      confirmHold: (0, import_vue.unref)(propsDetail).confirmHold,
                      autoBlur: (0, import_vue.unref)(propsDetail).autoBlur,
                      holdKeyboard: (0, import_vue.unref)(propsDetail).holdKeyboard,
                      adjustPosition: (0, import_vue.unref)(propsDetail).adjustPosition,
                      type: (0, import_vue.unref)(propsDetail).type,
                      placeholder: (0, import_vue.unref)(propsDetail).placeholder,
                      style: (0, import_vue.normalizeStyle)([
                        {
                          height: `${(0, import_vue.unref)(_height)}rpx`,
                          color: (0, import_vue.unref)(propsDetail).fontColor ? (0, import_vue.unref)(propsDetail).fontColor : (0, import_vue.unref)(tmcomputed).textColor,
                          "text-align": props.align,
                          "fontSize": `${(0, import_vue.unref)(propsDetail).fontSize_px}px`
                        }
                      ]),
                      placeholderStyle: `fontSize:${(0, import_vue.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "password", "maxlength", "disabled", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "type", "placeholder", "placeholderStyle"])) : (0, import_vue.createCommentVNode)("v-if", true),
                    (0, import_vue.unref)(propsDetail).type == "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-textarea", {
                      key: 1,
                      userInteractionEnabled: false,
                      value: _value.value,
                      focus: (0, import_vue.unref)(propsDetail).focus,
                      ...
                      autoBlur: (0, import_vue.unref)(propsDetail).autoBlur,
                      holdKeyboard: (0, import_vue.unref)(propsDetail).holdKeyboard,
                      cursor: (0, import_vue.unref)(propsDetail).cursor,
                      showConfirmBar: (0, import_vue.unref)(propsDetail).showConfirmBar,
                      selectionStart: (0, import_vue.unref)(propsDetail).selectionStart,
                      selectionEnd: (0, import_vue.unref)(propsDetail).selectionEnd,
                      disableDefaultPadding: (0, import_vue.unref)(propsDetail).disableDefaultPadding,
                      fixed: (0, import_vue.unref)(propsDetail).fixed,
                      adjustPosition: (0, import_vue.unref)(propsDetail).adjustPosition,
                      type: (0, import_vue.unref)(propsDetail).type,
                      style: (0, import_vue.normalizeStyle)([
                        {
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "maxlength", "disabled", "placeholder", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "cursor", "showConfirmBar", "selectionStart", "selectionEnd", "disableDefaultPadding", "fixed", "adjustPosition", "type", "placeholderStyle"])) : (0, import_vue.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  isAndroid.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 4,
                    class: "flex-1 relative flex-row flex",
                    ...
                    (0, import_vue.unref)(propsDetail).type != "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-input", {
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "password", "disabled", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "maxlength", "type", "placeholder", "placeholderStyle"])) : (0, import_vue.createCommentVNode)("v-if", true),
                    (0, import_vue.unref)(propsDetail).type == "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("u-textarea", {
                      key: 1,
                      ...
                      adjustPosition: (0, import_vue.unref)(propsDetail).adjustPosition,
                      maxlength: (0, import_vue.unref)(propsDetail).maxlength,
                      autoHeight: (0, import_vue.unref)(propsDetail).autoHeight,
                      cursor: (0, import_vue.unref)(propsDetail).cursor,
                      showConfirmBar: (0, import_vue.unref)(propsDetail).showConfirmBar,
                      selectionStart: (0, import_vue.unref)(propsDetail).selectionStart,
                      selectionEnd: (0, import_vue.unref)(propsDetail).selectionEnd,
                      ...
                      placeholderStyle: `fontSize:${(0, import_vue.unref)(propsDetail).fontSize_px}px`
                    }, null, 44, ["value", "focus", "disabled", "placeholder", "cursorSpacing", "confirmType", "confirmHold", "autoBlur", "holdKeyboard", "adjustPosition", "maxlength", "autoHeight", "cursor", "showConfirmBar", "selectionStart", "selectionEnd", "disableDefaultPadding", "fixed", "type", "placeholderStyle"])) : (0, import_vue.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.unref)(propsDetail).showClear && (0, import_vue.unref)(_valueLenChar) > 0 ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 5,
                    class: "pl-16"
                  }, [
                    (0, import_vue.createVNode)(tmIcon, {
                      onClick: clearBtn,
                      "font-size": (0, import_vue.unref)(propsDetail).fontSize * 0.9,
                      name: "tmicon-times-circle-fill"
                    }, null, 8, ["font-size"])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  _requiredError.value ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 6,
                    class: "pl-16"
                  }, [
                    (0, import_vue.createVNode)(tmIcon, {
                  ...
                  (0, import_vue.unref)(propsDetail).suffix ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 7,
                    class: "pl-16"
                  }, [
                    (0, import_vue.createVNode)(tmIcon, {
                      "font-size": (0, import_vue.unref)(propsDetail).fontSize * 0.85,
                      name: (0, import_vue.unref)(propsDetail).suffix
                    }, null, 8, ["font-size", "name"])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.unref)(propsDetail).suffixLabel ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 8,
                    class: "pl-16"
                  }, [
                    (0, import_vue.createVNode)(tmText, {
                      "font-size": (0, import_vue.unref)(propsDetail).fontSize,
                      label: (0, import_vue.unref)(propsDetail).suffixLabel
                    }, null, 8, ["font-size", "label"])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.unref)(showPasswordIcon) ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 9,
                    class: "pl-16"
                  }, [
                    (0, import_vue.createCommentVNode)(" tmicon-eyeslash-fill "),
                    (0, import_vue.createVNode)(tmIcon, {
                  ...
                  (0, import_vue.unref)(propsDetail).showCharNumber && (0, import_vue.unref)(_valueLenChar) > 0 && (0, import_vue.unref)(propsDetail).type != "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 10,
                    class: "pl-16 flex-row flex"
                  }, [
                    (0, import_vue.createVNode)(tmText, { label: (0, import_vue.unref)(_valueLenChar) }, null, 8, ["label"]),
                    (0, import_vue.unref)(propsDetail).maxlength > 0 ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                      key: 0,
                      label: "/" + (0, import_vue.unref)(propsDetail).maxlength
                    }, null, 8, ["label"])) : (0, import_vue.createCommentVNode)("v-if", true)
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  (0, import_vue.unref)(propsDetail).showCharNumber && (0, import_vue.unref)(_valueLenChar) > 0 && (0, import_vue.unref)(propsDetail).type == "textarea" ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 11,
                  ...
                  (0, import_vue.renderSlot)(_ctx.$slots, "right", {}, () => [
                    (0, import_vue.unref)(propsDetail).search || (0, import_vue.unref)(propsDetail).searchLabel ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                      ...
                      (0, import_vue.createVNode)(tmButton, {
                        ...
                        color: props.focusColor,
                        "font-size": 24,
                        height: (0, import_vue.unref)(_height) - 11,
                        padding: [16, 0],
                        block: "",
                        margin: [0, 0],
                        icon: (0, import_vue.unref)(propsDetail).search,
                        label: (0, import_vue.unref)(propsDetail).searchLabel
            ...
            (0, import_vue.createCommentVNode)(' <view v-if="propsDetail.showBottomBotder" :class="[`mt-${props.margin[1]*2}`]">\r\n            <tm-divider :margin="[0,0]"></tm-divider>\r\n        </view> '),
            (0, import_vue.createCommentVNode)(" _requiredError "),
            (0, import_vue.createCommentVNode)(' <view v-if="false" class="pt-12">\r\n            <tmText :font-size="24" color="red" :label="_errorLabel"></tmText>\r\n        </view> ')
          ]),
          _: 3
        }, 8, ["margin", "padding"]);
      };
  ...
  var _sfc_main$8 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    __name: "tm-divider",
    props: __spreadProps(__spreadValues({}, custom_props), {
      color: {
        type: String,
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", null, [
          !props.label || props.vertical ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
            key: 0,
            style: (0, import_vue.normalizeStyle)([(0, import_vue.unref)(tmcomputed).borderCss, props.vertical ? { width: "0px", height: props.height + "rpx" } : ""]),
  ...
  var _sfc_main$7 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const customCSSStyle = (0, import_vue.computed)(() => computedStyle(props));
      const customClass = (0, import_vue.computed)(() => computedClass(props));
      const istext = (0, import_vue.computed)(() => {
        return isNaN(parseInt(String(props.count)));
      });
      const show = (0, import_vue.computed)(() => {
        if (!props.dot && !props.icon && !props.count)
          return false;
        return true;
      });
      const size = (0, import_vue.computed)(() => {
      ...
      const _icon = (0, import_vue.computed)(() => props.icon);
      const _dot = (0, import_vue.computed)(() => props.dot);
      const _count = (0, import_vue.computed)(() => props.count);
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          class: (0, import_vue.normalizeClass)(["flex", [props.status ? "flex-row flex-row-center-center mx-8" : ""]])
        }, [
          !props.status ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", { key: 0 }, [
            (0, import_vue.renderSlot)(_ctx.$slots, "default")
          ])) : (0, import_vue.createCommentVNode)("v-if", true),
          (0, import_vue.unref)(show) ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
            key: 1,
            class: (0, import_vue.normalizeClass)([
              ((0, import_vue.unref)(_dot) || (0, import_vue.unref)(_count) || (0, import_vue.unref)(_icon)) && !props.status ? "absolute flex-top-start-end r-0" : ""
            ]),
            style: { zIndex: 10 }
          }, [
            (0, import_vue.createVNode)(tmSheet, {
              onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
              color: props.color,
              _class: [(0, import_vue.unref)(customClass), "flex-center flex-col"],
              _style: [(0, import_vue.unref)(customCSSStyle), { flexShrink: 1 }],
              followTheme: props.followTheme,
              dark: props.dark,
              round: props.round,
              shadow: props.shadow,
              ...
              linear: props.linear,
              linearDeep: props.linearDeep,
              width: (0, import_vue.unref)(size).w,
              height: (0, import_vue.unref)(size).h,
              margin: props.margin,
              padding: props.padding
            }, {
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.unref)(_count) > 0 && !(0, import_vue.unref)(istext) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                  key: 0,
                  color: "white",
                  "font-size": props.fontSize,
                  _class: (0, import_vue.unref)(size).h == 0 ? "py-3 px-8" : "",
                  label: (0, import_vue.unref)(_count) > props.maxCount ? props.maxCount + "+" : (0, import_vue.unref)(_count)
                }, null, 8, ["font-size", "_class", "label"])) : (0, import_vue.createCommentVNode)("v-if", true),
                (0, import_vue.unref)(_count) && (0, import_vue.unref)(istext) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                  key: 1,
                  color: "white",
                  "font-size": props.fontSize,
                  _class: (0, import_vue.unref)(size).h == 0 ? "py-3 px-8" : "",
                  label: (0, import_vue.unref)(_count)
                }, null, 8, ["font-size", "_class", "label"])) : (0, import_vue.createCommentVNode)("v-if", true),
                (0, import_vue.unref)(_icon) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                  key: 2,
                  color: "white",
                  "font-size": props.fontSize,
                  name: (0, import_vue.unref)(_icon)
                }, null, 8, ["font-size", "name"])) : (0, import_vue.createCommentVNode)("v-if", true)
              ]),
              _: 1
          ...
          props.status ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
            key: 2,
            "font-size": props.fontSize,
            _class: "ml-10",
            label: props.label
          }, null, 8, ["font-size", "label"])) : (0, import_vue.createCommentVNode)("v-if", true)
        ], 2);
      };
    }
  });
  ...
  var _sfc_main$6 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _colWidth = (0, import_vue.inject)("tmGridItemWidth", 0);
      const _tmGridshowBorder = (0, import_vue.inject)("tmGridshowBorder", (0, import_vue.computed)(() => false));
      const tmGridshowCachList = (0, import_vue.inject)("tmGridshowCachList", (0, import_vue.computed)(() => []));
      const uid = (0, import_vue.ref)({
      ...
      let wkStyle = (0, import_vue.ref)(`width:${_colWidth}'rpx'`);
      (0, import_vue.watch)([tmGridshowCachList, _tmGridshowBorder], () => {
        (0, import_vue.nextTick)(() => setStyleFun());
      }, { deep: true });
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
          style: (0, import_vue.normalizeStyle)((0, import_vue.unref)(wkStyle))
        }, [
          (0, import_vue.createVNode)(tmSheet, {
            color: props.bgColor,
            text: props.text,
            ...
            transprent: props.transprent,
            height: props.height,
            width: (0, import_vue.unref)(_colWidth) - 0.5,
            margin: [0, 0],
            padding: [0, 0],
            ...
            default: (0, import_vue.withCtx)(() => [
              (0, import_vue.createElementVNode)("view", { class: "flex-1 flex flex-col-center-center" }, [
                (0, import_vue.createVNode)(tmBadge, {
                  ...
                  default: (0, import_vue.withCtx)(() => [
                    (0, import_vue.createElementVNode)("view", { class: "flex-col flex-col-center-center flex px-10" }, [
                      (0, import_vue.renderSlot)(_ctx.$slots, "default")
                    ])
                  ]),
                  _: 3
  ...
  var _sfc_main$5 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { expose }) {
      const props = __props;
      let _cachList = (0, import_vue.ref)([]);
      const _colWidth = (0, import_vue.computed)(() => props.width / props.col);
      (0, import_vue.provide)("tmGridItemWidth", _colWidth.value + (props.showBorder ? 1 : 0));
      (0, import_vue.provide)("tmGridshowBorder", (0, import_vue.computed)(() => props.showBorder));
      (0, import_vue.provide)("tmGridshowCachList", (0, import_vue.computed)(() => _cachList.value));
      function pushKey(e) {
  ...
  var _sfc_main$4 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _barHeight = (0, import_vue.computed)(() => statusBarHeight + _height.value);
      const _leftWidth = (0, import_vue.computed)(() => props.leftWidth);
      const _rightWidth = (0, import_vue.computed)(() => props.rightWidth);
      const contentwidth = (0, import_vue.computed)(() => {
        return _width - uni.upx2px(_leftWidth.value) - uni.upx2px(_rightWidth.value);
      });
      const _title = (0, import_vue.computed)(() => props.title);
      const _fontColor = (0, import_vue.computed)(() => props.fontColor);
      const _homeColor = (0, import_vue.computed)(() => props.homeColor);
      const _blur = (0, import_vue.computed)(() => props.blur);
      const _pages = (0, import_vue.ref)(0);
      (0, import_vue.onMounted)(() => {
      ...
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", null, [
          (0, import_vue.createElementVNode)("view", {
            class: "statusHeight",
            style: (0, import_vue.normalizeStyle)({ height: (0, import_vue.unref)(_barHeight) + "px" })
          }, null, 4),
          (0, import_vue.createElementVNode)("view", {
            class: "fixed l-0 t-0 statusHeightTop flex",
            style: (0, import_vue.normalizeStyle)({ width: (0, import_vue.unref)(_width) + "px", height: (0, import_vue.unref)(_barHeight) + "px" })
          }, [
            (0, import_vue.createVNode)(tmSheet, {
              onClick: _cache[0] || (_cache[0] = ($event) => emits("click", $event)),
              blur: (0, import_vue.unref)(_blur),
              color: props.color,
              _class: _ctx._class,
              _style: _ctx._style,
              followTheme: props.followTheme,
              ...
              margin: props.margin,
              padding: props.padding,
              height: (0, import_vue.unref)(_barHeight),
              width: (0, import_vue.unref)(_width),
              unit: "px"
            }, {
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.createElementVNode)("view", {
                  class: "statusHeight",
                  style: (0, import_vue.normalizeStyle)({ height: (0, import_vue.unref)(statusBarHeight) + "px" })
                }, null, 4),
                (0, import_vue.createElementVNode)("view", { class: "flex flex-row flex-1 flex-row flex-row-center-betweent" }, [
                  (0, import_vue.createElementVNode)("view", {
                    class: "flex-row flex flex-row-center-start pl-24",
                    style: (0, import_vue.normalizeStyle)({ width: (0, import_vue.unref)(_leftWidth) + "rpx" })
                  }, [
                    _pages.value > 1 ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                      key: 0,
                      unit: props.unit,
                    ...
                    }, null, 8, ["unit", "font-size"])) : (0, import_vue.createCommentVNode)("v-if", true),
                    _pages.value == 1 && !__props.hideHome ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                      key: 1,
                      unit: props.unit,
                      _class: "pointer",
                      onClick: backhome,
                      color: (0, import_vue.unref)(_homeColor),
                      "font-size": props.iconFontSize,
                      name: "tmicon-md-home"
                    }, null, 8, ["unit", "color", "font-size"])) : (0, import_vue.createCommentVNode)("v-if", true),
                    (0, import_vue.renderSlot)(_ctx.$slots, "left")
                  ], 4),
                  (0, import_vue.createElementVNode)("view", {
                    class: "flex flex-row-center-center",
                    style: (0, import_vue.normalizeStyle)({ width: (0, import_vue.unref)(contentwidth) + "px" })
                  }, [
                    (0, import_vue.renderSlot)(_ctx.$slots, "default", {}, () => [
                      (0, import_vue.createVNode)(tmText, {
                        unit: props.unit,
                        ...
                        color: (0, import_vue.unref)(_fontColor),
                        "font-size": props.fontSize,
                        label: (0, import_vue.unref)(_title)
                      }, null, 8, ["unit", "color", "font-size", "label"])
                    ])
                  ], 4),
                  (0, import_vue.createElementVNode)("view", {
                    class: "flex-row flex flex-row-center-end pr-24",
                    style: (0, import_vue.normalizeStyle)({ width: (0, import_vue.unref)(_rightWidth) + "rpx" })
                  }, [
                    (0, import_vue.renderSlot)(_ctx.$slots, "right")
                  ], 4)
                ])
  ...
  var _sfc_main$2 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { emit: emits }) {
      ...
      const _computedValue = (0, import_vue.computed)(() => props);
      return (_ctx, _cache) => {
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", { class: "relative overflow" }, [
          (0, import_vue.createVNode)(tmSheet, {
            onClick: cellClick,
            color: props.color,
            followTheme: props.followTheme,
            ...
            default: (0, import_vue.withCtx)(() => [
              (0, import_vue.createElementVNode)("view", {
                userInteractionEnabled: true,
                class: (0, import_vue.normalizeClass)(["flex flex-row flex-row-center-center", [(0, import_vue.unref)(_computedValue).url ? "url" : ""]])
              }, [
                (0, import_vue.unref)(_computedValue).showAvatar ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                  key: 0,
                  style: (0, import_vue.normalizeStyle)({
                    width: `${(0, import_vue.unref)(_computedValue).avatarSize}rpx`,
                    height: `${(0, import_vue.unref)(_computedValue).avatarSize}rpx`
                  }),
                  class: "flex flex-row flex-row-center-center"
                }, [
                  (0, import_vue.renderSlot)(_ctx.$slots, "avatar", {}, () => [
                    (0, import_vue.createVNode)(tmImage, {
                      round: (0, import_vue.unref)(_computedValue).avatarRound,
                      width: (0, import_vue.unref)(_computedValue).avatarSize,
                      height: (0, import_vue.unref)(_computedValue).avatarSize,
                      src: (0, import_vue.unref)(_computedValue).avatar
                ...
                (0, import_vue.createElementVNode)("view", {
                  ...
                  (0, import_vue.createElementVNode)("view", {
                    class: (0, import_vue.normalizeClass)(["flex flex-5 flex-col", [(0, import_vue.unref)(_computedValue).showAvatar ? "pl-24" : ""]])
                  }, [
                    (0, import_vue.renderSlot)(_ctx.$slots, "title", {}, () => [
                      (0, import_vue.createVNode)(tmText, {
                        fontSize: (0, import_vue.unref)(_computedValue).titleFontSize,
                        label: (0, import_vue.unref)(_computedValue).title
                      }, null, 8, ["fontSize", "label"])
                    ]),
                    (0, import_vue.renderSlot)(_ctx.$slots, "label", {}, () => [
                      (0, import_vue.unref)(_computedValue).label ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                        key: 0,
                        class: "mt-6"
                      }, [
                        (0, import_vue.createVNode)(tmText, {
                          color: (0, import_vue.unref)(_computedValue).labelColor,
                          fontSize: 22,
                          label: (0, import_vue.unref)(_computedValue).label
                        }, null, 8, ["color", "label"])
                      ])) : (0, import_vue.createCommentVNode)("v-if", true)
                    ])
                  ], 2)
                ...
                (0, import_vue.createElementVNode)("view", {
                  ...
                  (0, import_vue.createElementVNode)("view", { class: "flex flex-1 flex-row flex-row-center-end pr-12" }, [
                    (0, import_vue.renderSlot)(_ctx.$slots, "rightText", {}, () => [
                      (0, import_vue.unref)(_computedValue).rightText ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                        key: 0,
                        color: (0, import_vue.unref)(_computedValue).rightColor,
                        fontSize: 24,
                        label: (0, import_vue.unref)(_computedValue).rightText
                      }, null, 8, ["color", "label"])) : (0, import_vue.createCommentVNode)("v-if", true)
                    ])
                  ]),
                  (0, import_vue.renderSlot)(_ctx.$slots, "right", {}, () => [
                    (0, import_vue.unref)(_computedValue).rightIcon ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                      key: 0,
                      _class: "opacity-3",
                      name: (0, import_vue.unref)(_computedValue).rightIcon,
                      fontSize: 22
                    }, null, 8, ["name"])) : (0, import_vue.createCommentVNode)("v-if", true)
                  ])
                ])
              ], 2)
            ]),
          ...
          (0, import_vue.unref)(_computedValue).bottomBorder ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmDivider, {
            key: 0,
            margin: [0, 0],
            style: (0, import_vue.normalizeStyle)({
              left: `${(0, import_vue.unref)(_computedValue).avatar !== "" ? (0, import_vue.unref)(_computedValue).avatarSize + (0, import_vue.unref)(_computedValue).margin[0] : 0}rpx`
            })
          }, null, 8, ["style"])) : (0, import_vue.createCommentVNode)("v-if", true)
        ]);
      };
    }
  });
  ...
  var _sfc_main$1 = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props, { expose, emit: emits }) {
      ...
      const isDark = (0, import_vue.computed)(() => computedDark(props, tmcfg.value));
      const tmcomputed = (0, import_vue.computed)(() => computedTheme(props, isDark.value, tmcfg.value));
      const syswidth = (0, import_vue.ref)(0);
      const sysheight = (0, import_vue.ref)(0);
      const reverse = (0, import_vue.ref)(true);
      const aniEnd = (0, import_vue.ref)(false);
      const flag = (0, import_vue.ref)(null);
      const timeid = (0, import_vue.ref)(null);
      ...
      (0, import_vue.watch)(() => props.show, (val2) => {
        if (val2) {
          open();
        } else {
          close();
      ...
      (0, import_vue.onMounted)(() => open());
      const ok_loading = (0, import_vue.computed)(() => props.okLoading);
      const round_rp = (0, import_vue.computed)(() => {
      ...
      const reverse_rp = (0, import_vue.computed)(() => {
        if (aniname.value != "zoom")
          return reverse.value;
        return !reverse.value;
      });
      const aniname = (0, import_vue.computed)(() => {
      ...
      const anwidth = (0, import_vue.computed)(() => {
        if (aniname.value == "zoom") {
          return props.width + "rpx";
        }
      ...
      const anheight = (0, import_vue.computed)(() => {
        let wucha = 0;
      ...
      const contentHeight = (0, import_vue.computed)(() => {
      ...
      const align_rp = (0, import_vue.computed)(() => {
        if (aniname.value == "down") {
      ...
      expose({ close, open });
      return (_ctx, _cache) => {
        return __props.show ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmOverlay, {
          key: 0,
          transprent: !props.mask,
          onClick: clickClose,
          align: (0, import_vue.unref)(align_rp),
          overlayClick: false,
          show: props.show,
          ...
          default: (0, import_vue.withCtx)(() => [
            (0, import_vue.createVNode)(tmTranslate, {
              ...
              reverse: (0, import_vue.unref)(reverse_rp),
              width: (0, import_vue.unref)(anwidth),
              height: (0, import_vue.unref)(anheight),
              ref: "drawerANI",
              "auto-play": false,
              name: (0, import_vue.unref)(aniname),
              duration: props.duration
            }, {
              default: (0, import_vue.withCtx)(() => [
                (0, import_vue.createElementVNode)("view", {
                  onClick: _cache[0] || (_cache[0] = (0, import_vue.withModifiers)(($event) => $event.stopPropagation(), ["stop"])),
                  style: (0, import_vue.normalizeStyle)([
                    { width: (0, import_vue.unref)(anwidth), height: (0, import_vue.unref)(anheight) },
                    !props.transprent ? (0, import_vue.unref)(tmcomputed).borderCss : "",
                    !props.transprent ? (0, import_vue.unref)(tmcomputed).backgroundColorCss : "",
                    !props.transprent ? (0, import_vue.unref)(tmcomputed).shadowColor : "",
                    (0, import_vue.unref)(customCSSStyle)
                  ]),
                  class: (0, import_vue.normalizeClass)([(0, import_vue.unref)(round_rp), "flex flex-col overflow ", (0, import_vue.unref)(customClass)])
                }, [
                  !props.closeable && !props.hideHeader ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 0,
                    class: "flex flex-row flex-row-center-center flex-between px-24",
                    style: { "height": "44px" }
                  }, [
                    (0, import_vue.createElementVNode)("view", { class: "flex-4 flex-shrink" }, [
                      !props.hideCancel ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                        key: 0,
                        onClick: cancel,
                        label: props.cancelText
                      }, null, 8, ["label"])) : (0, import_vue.createCommentVNode)("v-if", true)
                    ]),
                    (0, import_vue.createElementVNode)("view", { class: "flex-8 px-32 flex-center" }, [
                      (0, import_vue.createVNode)(tmText, {
                        _class: "text-overflow-1 opacity-7",
                        label: props.title
                      }, null, 8, ["label"])
                    ]),
                    (0, import_vue.createElementVNode)("view", { class: "flex-4 flex-shrink flex-row flex-row-center-end" }, [
                      !(0, import_vue.unref)(ok_loading) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmText, {
                        key: 0,
                        color: __props.okColor,
                        onClick: ok,
                        dark: props.dark,
                        label: props.okText
                      }, null, 8, ["color", "dark", "label"])) : (0, import_vue.createCommentVNode)("v-if", true),
                      (0, import_vue.unref)(ok_loading) ? ((0, import_vue.openBlock)(), (0, import_vue.createBlock)(tmIcon, {
                        key: 1,
                        color: __props.okColor,
                        spin: (0, import_vue.unref)(ok_loading),
                        dark: (0, import_vue.unref)(isDark),
                        _class: (0, import_vue.unref)(isDark) !== true ? "opacity-4" : "",
                        fontSize: 34,
                        name: (0, import_vue.unref)(ok_loading) ? "tmicon-jiazai_dan" : "tmicon-times-circle-fill"
                      }, null, 8, ["color", "spin", "dark", "_class", "name"])) : (0, import_vue.createCommentVNode)("v-if", true)
                    ])
                  ])) : (0, import_vue.createCommentVNode)("v-if", true),
                  props.closeable && !props.hideHeader ? ((0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("view", {
                    key: 1,
                    ...
                    (0, import_vue.createElementVNode)("view", { class: "flex-9 pr-32" }, [
                      (0, import_vue.createVNode)(tmText, {
                        _class: "text-overflow-1 opacity-7",
                        dark: props.dark,
                        label: props.title
                    ...
                    (0, import_vue.createElementVNode)("view", { class: "flex-3 flex-shrink flex-row flex-row-center-end" }, [
                      (0, import_vue.createVNode)(tmIcon, {
                        onClick: cancel,
                        dark: props.dark,
                        _class: (0, import_vue.unref)(isDark) !== true ? "opacity-3" : "",
                        fontSize: 36,
                        name: "tmicon-times-circle-fill"
                      }, null, 8, ["dark", "_class"])
                    ])
                  ...
                  (0, import_vue.createElementVNode)("scroll-view", {
                    scrollY: "",
                    style: (0, import_vue.normalizeStyle)([{ height: (0, import_vue.unref)(contentHeight) }]),
                    class: "overflow"
                  }, [
                    (0, import_vue.renderSlot)(_ctx.$slots, "default")
                  ], 4)
          ...
          _: 3
        }, 8, ["transprent", "align", "show"])) : (0, import_vue.createCommentVNode)("v-if", true);
      };
    }
  });
  ...
  var _sfc_main = /* @__PURE__ */ (0, import_vue.defineComponent)({
    ...
    setup(__props) {
      ...
      const str = (0, import_vue.ref)("");
      const showCustomColor = (0, import_vue.ref)("#60ab41");
      const showCustomName = (0, import_vue.ref)("darkGreen");
      const showCustom = (0, import_vue.ref)(false);
      ...
      return (_ctx, _cache) => {
        ...
        return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
          ...
          (0, import_vue.createVNode)(tmApp, { ref: "app" }, {
            default: (0, import_vue.withCtx)(() => [
              (0, import_vue.createVNode)(tmNavbar, {
                title: (0, import_vue.unref)(language)("index.com.navtitle"),
                shadow: 0,
                "hide-home": ""
              }, {
                left: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createElementVNode)("view", { class: "flex flex-center flex-row" }, [
                    ...
                    (0, import_vue.createVNode)(tmIcon, {
                      ...
                      color: (0, import_vue.unref)(store).tmStore.dark ? "yellow" : "",
                      _class: "pl-32",
                      "font-size": 42,
              ...
              (0, import_vue.createVNode)(tmSheet, {
                ...
                default: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createElementVNode)("view", { class: "flex-row flex-row-center-start pb-10" }, [
                    (0, import_vue.createVNode)(tmImage, {
                      width: 108,
                      height: 67.5,
                      src: (0, import_vue.unref)(logoimg)
                    }, null, 8, ["height", "src"]),
                    (0, import_vue.createElementVNode)("view", {
                      class: "pl-16 flex-1",
                      style: { "width": "0px" }
                      ...
                      (0, import_vue.createVNode)(tmText, {
                        _class: "opacity-6",
                        label: (0, import_vue.unref)(language)("index.search.subtext")
                      }, null, 8, ["label"])
                    ])
                  ])
                ]),
              ...
              (0, import_vue.createVNode)(tmSheet, { margin: [0, 0] }, {
                default: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createVNode)(tmInput, {
                    placeholder: (0, import_vue.unref)(language)("index.search.tips"),
                    border: 1,
                    showClear: "",
                    ...
                    onSearch: search,
                    searchLabel: (0, import_vue.unref)(language)("index.search.btntext")
                  }, null, 8, ["placeholder", "modelValue", "searchLabel"])
                ]),
                _: 1
              }),
              (0, import_vue.createElementVNode)("view", { class: "mt-24" }),
              (0, import_vue.createVNode)(tmSheet, {
                margin: [32, 0],
                round: 3
              }, {
                default: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createVNode)(tmText, {
                    ...
                    label: (0, import_vue.unref)(language)("index.com.themetext")
                  }, null, 8, ["label"]),
                  (0, import_vue.createVNode)(tmDivider),
                  (0, import_vue.createElementVNode)("view", { class: "flex flex-row flex-around" }, [
                    (0, import_vue.createVNode)(tmButton, {
                      width: 100,
                      color: "yellow",
                      size: "small",
                      onClick: _cache[1] || (_cache[1] = ($event) => setTheme("yellow")),
                      label: (0, import_vue.unref)(language)("index.com.themeGreen")
                    }, null, 8, ["label"]),
                    (0, import_vue.createVNode)(tmButton, {
                      width: 100,
                      color: "blue",
                      ...
                      label: (0, import_vue.unref)(language)("index.com.themeBlue")
                    }, null, 8, ["label"]),
                    (0, import_vue.createVNode)(tmButton, {
                      width: 100,
                      color: "red",
                      ...
                      label: (0, import_vue.unref)(language)("index.com.themeRed")
                    }, null, 8, ["label"]),
                    (0, import_vue.createVNode)(tmButton, {
                      color: "brown",
                      shadow: 0,
                      ...
                      label: (0, import_vue.unref)(language)("index.com.themeCustText")
                    }, null, 8, ["label"]),
                    (0, import_vue.createVNode)(tmButton, {
                      width: 160,
                      size: "small",
                      onClick: _cache[5] || (_cache[5] = ($event) => setTheme("")),
                      label: (0, import_vue.unref)(language)("index.com.themeDefault")
                    }, null, 8, ["label"])
                  ])
                ]),
                _: 1
              ...
              (0, import_vue.createVNode)(tmSheet, {
                ...
                default: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createVNode)(tmText, {
                    "font-size": 24,
                    _class: "font-weight-b",
                    label: (0, import_vue.unref)(language)("index.com.title")
                  }, null, 8, ["label"]),
                  (0, import_vue.createVNode)(tmDivider),
                  (0, import_vue.createVNode)(tmGrid, {
                    col: 3,
                    width: 630
                  }, {
                    default: (0, import_vue.withCtx)(() => [
                      (0, import_vue.createVNode)(tmGridItem, {
                        url: "../changyong/index",
                        height: 180,
                        count: 3,
                        color: "primary"
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.tongyong")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.tongyongSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.row")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.rowSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.show")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.showSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.form")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.formSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.fd")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.fdSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.nav")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.navSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.yewu")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.yewuSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.other")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.otherSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      }),
                      (0, import_vue.createVNode)(tmGridItem, {
                        ...
                        default: (0, import_vue.withCtx)(() => [
                          ...
                          (0, import_vue.createVNode)(tmText, {
                            "font-size": 28,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.tubiao")
                          }, null, 8, ["label"]),
                          (0, import_vue.createVNode)(tmText, {
                            color: "grey",
                            "font-size": 22,
                            _class: "font-weight-b",
                            label: (0, import_vue.unref)(language)("index.com.tubiaoSub")
                          }, null, 8, ["label"])
                        ]),
                        _: 1
                      })
              ...
              (0, import_vue.createVNode)(tmCell, {
                url: "../wxaccount/user",
                margin: [32, 16],
                showAvatar: "",
                round: 3,
                titleFontSize: 30,
                title: (0, import_vue.unref)(language)("index.com.love"),
                label: "\u53EF\u767B\u5F55\u6A21\u677F\u5E02\u573A",
                rightText: (0, import_vue.unref)(language)("index.com.loveSub")
              }, {
                avatar: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createVNode)(tmIcon, {
                    color: "orange",
                    "font-size": 38,
              ...
              (0, import_vue.createVNode)(tmCell, {
                ...
                round: 3,
                titleFontSize: 30,
                title: (0, import_vue.unref)(language)("index.com.setLocal"),
                rightText: (0, import_vue.unref)(language)("language")
              }, {
                avatar: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createVNode)(tmIcon, {
                    color: "primary",
              ...
              (0, import_vue.createElementVNode)("view", { class: "py-32 mx-32" }, [
                (0, import_vue.createVNode)(tmDivider, {
                  color: "grey-2",
                  label: (0, import_vue.unref)(language)("index.com.bottom")
                }, null, 8, ["label"])
              ]),
              (0, import_vue.createVNode)(tmFloatButton, {
                onClick: onChangeDark,
                btn: { icon: "tmicon-ios-sunny", color: "pink", linear: "right" }
              }),
              (0, import_vue.createVNode)(tmMessage, { ref: "msg" }, null, 512),
              (0, import_vue.createVNode)(tmDrawer, {
                ...
                default: (0, import_vue.withCtx)(() => [
                  (0, import_vue.createElementVNode)("view", { class: "pa-32 flex flex-col" }, [
                    (0, import_vue.createElementVNode)("view", { class: "text-align-center py-24" }, [
                      (0, import_vue.createVNode)(tmText, {
                        _class: "text-weight-b",
                        "font-size": 32,
                        label: "\u81EA\u5B9A\u4E49\u4E3B\u9898"
